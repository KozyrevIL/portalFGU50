<%@ Page Language="C#" AutoEventWireup="true"  CodeFile="news_oks.aspx.cs"  Inherits="_Default" %>
                        ...
                        <div class="posForm">
                            <div id="bottom_base_text" style="width: 100%;">
                                <div style="margin-bottom: 20px">
                                    <asp:Label ID="Label2" runat="server" Text="Новости ОКС" CssClass="headerRazdel"></asp:Label>
                                </div>
