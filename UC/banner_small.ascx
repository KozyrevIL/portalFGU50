<%@ Control Language="C#" AutoEventWireup="true" CodeFile="banner_small.ascx.cs" Inherits="UC_admin_banner" %>
    ...
    <div style="height: 20px; background-color: #9999CC; width:100%">
        ...
        <div style="text-align: right; margin-right: 10px;">
            ...
            <div style="float:left; width:200px;">
                <asp:LinkButton ID="LinkButtonOutConsol" CssClass="header_links" runat="server" Text="Возврат на портал"
                    OnClick="LinkButtonOutConsol_Click" CausesValidation=false></asp:LinkButton>
            </div>
            <div style="margin-right: 5px; width:350px; float:left;">
                <a href="../Admin/admin.aspx" class="header_links"></a>
            </div>
