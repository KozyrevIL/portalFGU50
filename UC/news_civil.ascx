<%@ Control Language="C#" AutoEventWireup="true" CodeFile="news_civil.ascx.cs" Inherits="UC_news_civil" %>
                ...
                <ItemTemplate>
                    <div id="border_type5">
                        <table cellpadding="0" cellspacing="0" border="0" width="100%">
                            ...
                            <tr>
                                <td>
                                    <asp:Label ID="LabelItem2Text_news" runat="server" CssClass="formText" Text='<%# Bind("text_news") %>'></asp:Label></td>
                            </tr>
                             <tr>
