<%@ Page Language="C#" MasterPageFile="~/Admin/MasterPageAdmin.master" AutoEventWireup="true"
    CodeFile="admin_news.aspx.cs" Theme="gridview" Inherits="Admin_smi" ValidateRequest="false" Title="Производственные новости" %>
        ...
        <table cellpadding="0" cellspacing="0" border="0" width="100%">
            <tr>
                <td height="47">
                    ...
                    <uc2:admin_banner ID="admin_banner1" header="ПОЗДРАВЛЕНИЯ" runat="server" />
                </td>
            </tr>
            <tr>
