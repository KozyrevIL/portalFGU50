...
public partial class Admin_smi : System.Web.UI.Page
{
    ...
    protected void SqlDataSourceSmi_Inserting(object sender, SqlDataSourceCommandEventArgs e)
    {
        ...
        try
        {
            ...
            e.Command.Parameters["@text_news"].Value = Editor5.Content;
            ...
            e.Command.Parameters["@type_news"].Value = 1; //поздравления
...
//string text_news = ((Editor)(GridView1.Rows[e.RowIndex].FindControl("EditorGrid"))).Content;
        int prioritet = Convert.ToInt16(((DropDownList)(GridView1.Rows[e.RowIndex].FindControl("DropDownListPrioritet"))).SelectedValue);
