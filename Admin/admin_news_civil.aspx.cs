...
public partial class Admin_news_civil : System.Web.UI.Page
{
    ...
    protected int type_news = 10; //Общественные новости
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
           ...
           //Admin_banner1.user_logon = user_logon;
            ...
            String strBegin_dateNews = DateTime.Now.AddDays(-20).ToShortDateString();
    ...
    protected void SqlDataSourceSmi_Inserting(object sender, SqlDataSourceCommandEventArgs e)
    {
        ...
        try
        {
            ...
            e.Command.Parameters["@type_news"].Value = type_news; //новости общественные @text_news_short
    ...
    protected void GridView1_RowDataBound1(object sender, GridViewRowEventArgs e)
    {
           ...
           (e.Row.RowState == DataControlRowState.Normal || e.Row.RowState == DataControlRowState.Alternate))
        {
            ...
            lBase_text.Text = lBase_text.Text.Length > 250 ? lBase_text.Text.Substring(0, 230) + "..." : lBase_text.Text;
            lHeader_news.Text = lHeader_news.Text.Length > 60 ? lHeader_news.Text.Substring(0, 50) + "..." : lHeader_news.Text;
    ...
    protected void GridView1_RowUpdating(object sender, GridViewUpdateEventArgs e)
    {
        ...
        // string text_news = ((Obout.Ajax.UI.HTMLEditor.Editor)(GridView1.Rows[e.RowIndex].FindControl("EditorGrid"))).Content;TextBoxEditorGrid
