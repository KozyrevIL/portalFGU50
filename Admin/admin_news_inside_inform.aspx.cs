...
public partial class Admin_smi : System.Web.UI.Page
{
    ...
    protected void SqlDataSourceSmi_Inserting(object sender, SqlDataSourceCommandEventArgs e)
    {
        ...
        try
        {
            ...
            e.Command.Parameters["@text_news"].Value = this.Editor3.Content;//FreeTextBox1.Text;//TextBoxNews_text.Text;
            ...
            e.Command.Parameters["@type_news"].Value = 5; //Служебная информация
    ...
    protected void GridView1_RowDataBound1(object sender, GridViewRowEventArgs e)
    {
        ...
        {
            TextBox TextBoxText_news = ((TextBox)e.Row.FindControl("TextBoxEditText_news"));
            //TextBoxText_news.Text = Server.(TextBoxText_news.Text);

            //string strEditor=((Label)e.Row.FindControl("LabelEditText_news")).Text;

            //((AjaxControlToolkit.HTMLEditor.Editor)e.Row.FindControl("Editor4")).Content = strEditor;
    ...
    protected void GridView1_RowUpdating(object sender, GridViewUpdateEventArgs e)
    {
        ...
        //Подгрузка текста TextBoxEditText_news

        //string text_news = ((AjaxControlToolkit.HTMLEditor.Editor)(GridView1.Rows[e.RowIndex].FindControl("Editor4"))).Content;
        string text_news = ((TextBox)(GridView1.Rows[e.RowIndex].FindControl("TextBoxEditText_news"))).Text;
