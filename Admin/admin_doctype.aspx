<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/admin_div.master" AutoEventWireup="true" CodeFile="admin_doctype.aspx.cs" Theme="gridview_small" Inherits="Admin_admin_doctype" %>
    ...
    contentplaceholderid="ContentPlaceHolder1">
        ...
        <div id="page">
            ...
            <asp:SqlDataSource ID="SqlDataSourceDocType" runat="server" 
                ...
                <SelectParameters>
                    <asp:Parameter DefaultValue="1" Name="type_info" Type="Int32" />
                </SelectParameters>
                <UpdateParameters>
                    <asp:Parameter Name="id_doctype" Type="Int32" />
                    <asp:Parameter Name="doctype_name" Type="String" />
