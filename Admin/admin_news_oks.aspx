<%@ Page Language="C#"  AutoEventWireup="true" MasterPageFile="~/Admin/MasterPageAdmin.master"
    CodeFile="admin_news_oks.aspx.cs" Theme="gridview" Inherits="Admin_smi" ValidateRequest="false" Title="Администрирование новостей" %>
            ...
            <tr>
                <td height="47">
                   <%-- <asp:ToolkitScriptManager ID="ToolkitScriptManager1" runat="server">
                    ...
                    <uc2:admin_banner ID="admin_banner1" header="Новости ОКС" runat="server" />
                </td>
            </tr>
            <tr>
                <td align="left" valign="top" bgcolor="white" style="height: 584px">
                    ...
                    <asp:SqlDataSource ID="SqlDataSourceNews" runat="server" ConnectionString="<%$ ConnectionStrings:portalFGU59ConnectionString %>"
                        ...
                        <SelectParameters>
                            ...
                            <asp:Parameter DefaultValue="8" Name="items" Type="String" />
