<%@ Page Language="C#"  AutoEventWireup="true" MasterPageFile="~/Admin/MasterPageAdmin.master"
    CodeFile="admin_news_civil.aspx.cs" Theme="gridview" Inherits="Admin_news_civil" ValidateRequest="false" Title="Администрирование новостей" %>
        ...
        <table cellpadding="0" cellspacing="0" border="0" width="100%">
            <tr>
                <td height="47">
                    ...
                    <uc2:admin_banner ID="admin_banner1" header="Общественные новости" runat="server" />
                </td>
            </tr>
            <tr>
                <td align="left" valign="top" bgcolor="white" style="height: 584px">
                            ...
                            <td width="80%" valign="top" align="left">
                                ...
                                <div class="posForm">
                                    <div id="input_border" class="formText">
                                        ...
                                        <div>
                                            Заголовок (показывается на первой странице)
                                        </div>
                                        <div>
                                            <asp:TextBox ID="TextBoxHeader_news" runat="server" Width="600px" Height="50px" TextMode="MultiLine"></asp:TextBox>
                                        </div>
                                        <div>
                                        ...
                                        <div>
                                            <cc1:Editor ID="Editor5" runat="server" ActiveMode="Html" Height="200px" Width="600px" />
                                        </div>
                                        <div>
                                            Фото
                                        </div>
                                        ...
                                        <div class="textError">
                                            <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ErrorMessage="Разрешены только графические форматы: jpg, gif, png"
                                                ...
                                                ControlToValidate="FileUploadImage"></asp:RegularExpressionValidator>
                                        </div>
                                        <div>
                                            Файл
                                        </div>
                                        ...
                                        <div>
                                            <div class="textError">
                                                <asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server" ErrorMessage="Разрешены форматы: jpg, gif, png, doc, docx, xls, xlsx, rar, zip, pdf"
                                                    ...
                                                    ControlToValidate="FileUploadFile"></asp:RegularExpressionValidator>
                                            </div>
                                            <div>
                                            ...
                                            <div>
                                                <asp:Button ID="ButtonInsertNews" runat="server" CssClass="formText"
                                                    Text="Добавить" OnClick="ButtonInsertNews_Click" />
                                            </div>
                                        </div>
                                        <div style="margin-top:10px">
                                            <asp:GridView ID="GridView1" runat="server" SkinID="Grid_small" AutoGenerateColumns="False"
                                                DataKeyNames="id_news,items" DataSourceID="SqlDataSourceNewsCivil" AllowPaging="True"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="Заголовок" SortExpression="header_news">
                                                        <ItemTemplate>
                                                            <asp:Label Width="200px" ID="LabelItemHeader_news" runat="server" Text='<%# Bind("header_news") %>'></asp:Label>
                                                        </ItemTemplate>
                                                    ...
                                                    <asp:TemplateField HeaderText="Текст" SortExpression="text_news">
                                                        <ItemTemplate>
                                                            <asp:Label Width="70%" ID="LabelItemText_news" runat="server" Text='<%# Bind("text_news") %>'></asp:Label>
                                                        </ItemTemplate>
                                                        <ItemStyle Width="100%" />
                                                        <EditItemTemplate>
                                                    ...
                                                    <asp:TemplateField HeaderText="Приоритет" SortExpression="prioritet_news">
                                                        <EditItemTemplate>
                                                            <%--<asp:TextBox ID="TextBox1" Width="50px" runat="server" Text='<%# Bind("prioritet_news") %>'></asp:TextBox>--%>
                    ...
                    &nbsp;&nbsp;&nbsp;
                    <asp:SqlDataSource ID="SqlDataSourceNewsCivil" runat="server" ConnectionString="<%$ ConnectionStrings:portalFGU59ConnectionString %>"
                        ...
                        <SelectParameters>
                            ...
                            <asp:Parameter DefaultValue="10" Name="items" Type="String" />
