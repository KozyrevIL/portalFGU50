...
<%@ Register Src="UC/Events_timer.ascx" TagName="Events_timer" TagPrefix="uc7" %>
<%@ Register Assembly="ASPNetFlash.NET2" Namespace="ASPNetFlash" TagPrefix="ASPNetFlash" %>
...
<%--<%@ Register Src="~/UC/uc_activities.ascx" TagPrefix="uc1" TagName="uc_activities" %>--%>
...
<style type="text/css">
    #wind {
        position: absolute;
        width: 1050px; /* ширина всплывающего окна */
        left: 20%; /* отступ от левого края экрана */
        top: 50px; /* отступ с верху экрана */
...
<link href="style/alexander/alexander.css" rel="stylesheet" type="text/css" />
                                ...
                                <div class="posForm">
                                    <div id="bottom_base_text" style="width: 100%;">
                                        ...
                                        <div style="clear: both">
                                            ...
                                            <%--<div id="border_type5">
                                                <div class="formText4">
                                                    <video id="movie" width="400" height="320" controls="controls" poster="ngvideo/ng.jpeg"  preload="metadata">
                                                        <source src="ngvideo/ng.mp4" type='video/mp4; codecs="avc1.42E01E, mp4a.40.2"'>
                                                        <a href="ngvideo/ng.mp4">Скачайте видео</a>
                                                    </video>
                                                </div>
                                            </div>
                                            <div id="border_type5">
                                                <div class="formText4">
                                                    <div style="font-size: 14px; color: red; text-align: center; font-family: Tahoma;"><b>Важная информация для Территориальных отделов филиала ФГБУ "ФКП Росреестра" по Пермскому краю</b></div>
                                                    <br />
                                                    <div style="font-size: 12px; font-family: Tahoma;">
                                                        Уважаемы пользователи <b>ТЕРРИТОРИАЛЬНЫХ ФИЛИАЛОВ</b>, просим вас скачать архив <b>"Для_филиалов_-_Dr.Web.zip"</b>, в нем открыть документ <b>"Для филиалов - Dr.Web.docx"</b> и удалить антивирус <b>Dr.Web</b>.<br />
                                                        <b>Пароль для архива</b>: 0000
                                                    </div>
                                                    <br />
                                                    <div>
                                                        <b>Скачать:</b>
                                                        <a href="DrWeb/Для_филиалов_-_Dr.Web.zip" style="text-decoration: none">Для_филиалов_-_Dr.Web.zip</a>
                                                    </div>
                                                    <br />
                                                    <br />
                                                    <div style="text-align: right; font-family: Tahoma; font-size: 11px; font-weight: normal; color: #949494;">
                                                        Автор новости: Зартдинов Янус Зубаирович
                                                    </div>
                                                </div>
                                            </div>
                                            <div id="border_type5">
                                                <div class="formText4">
                                                    ...
                                                    <br />
                                                    <div style="font-size: 12px; font-family: Tahoma;">
                                                        Уважаемы пользователи <b>ТЕРРИТОРИАЛЬНЫХ ФИЛИАЛОВ</b>, просим вас скачать архив <b>"Для_филиалов_-_Kaspersky.zip"</b>, в нем открыть документ <b>"Для филиалов - Kaspersky.docx"</b> и установить антивирус <b>Kaspersky</b>.<br />
                                                        <b>Пароль для архива</b>: 0000
                                                    </div>
                                                    <br />
                                                    <div>
                                                        <b>Скачать:</b>
                                                        <a href="Kaspersky/Для_филиалов_-_Kaspersky.zip" style="text-decoration: none">Для_филиалов_-_Kaspersky.zip</a>
                                                    </div>
                                                    <br />
                                                    <br />
                                                    <div style="text-align: right; font-family: Tahoma; font-size: 11px; font-weight: normal; color: #949494;">
                                            ...
                                            <%--<div id="border_type5">
                                                ...
                                                <div class="formText4">
                                                    <%--<div style="font-size: 18px; font-family: Tahoma; text-align: center; color: red; width: 1000px;">
                                                        Уважаемые коллеги!<br />
                                                        От лица руководства и коллектива кадастровой палаты,<br />
                                                        примите наши самые искренние и сердечные поздравления<br />
                                                        C международным женским днём!<br />
                                                        От всей души желаем вам здоровья, гармонии, любви, всегда и во всём оставаться образцом женственности и быть на высоте.<br />
                                                        Смелых и перспективных идей, здоровья, успехов и благополучия!
                                                    </div>--%>
                                                     <%--<div style="font-size: 18px; font-family: Tahoma; text-align: center; color: red; width: 1000px;">
                                                        Милые, дорогие, прекрасные женщины!
                                                    </div>
                                                    <br />
                                                    <%--<div style="font-size: 15px; font-family: Tahoma; text-align: center; width: 1000px;">
                                                        Весна за окнами сияет, посмотри!<br />
                                                        Прекрасен мир, цветением объят...<br />
                                                        Возьми же ясность утренней зари,<br />
                                                        Дыханья свежесть пусть подарит сад,<br />
                                                        И пусть сияют радостно глаза,<br />
                                                        И пусть душа от счастья запоет,<br />
                                                        Пусть мимо прошумит гроза,<br />
                                                        Пусть только радость дарит каждый год!
                                                    </div>--%>
                                                     <%--<div style="font-size: 15px; font-family: Tahoma; text-align: center; width: 1000px; color:blue;">
                                                        Дорогие наши!<br />
                                                        Поздравляем вас с Международным Днем Женщин!<br />
                                                        Века и тысячелетия мировой истории, озаренные вашей мудростью и нежностью, обаянием и красотой.<br />
                                                        И только благодаря вашей жизненной силе, воодушевлении и долготерпению из века в век продолжается род человеческий на земле.<br />
                                                        Мать, сестра, любимая - женский исток сопровождает нас до последнего вздоха.<br />
                                                        И если красота спасет мир, то это будет ваша красота.<br /> 
                                                        Ведь вы превращаете его в волшебную жемчужину, которую мы кладем к вашим ногам.<br />
                                                        В этот праздничный день желаем всем женщинам крепкого благосостояния, пожизненного счастья, неистовой любви и постоянного благополучия.<br />
                                                        И пусть выполняются все мечты, ведь желание каждой женщины - закон, которому мы, мужчины, с радостью подчиняемся.
                                                    </div>
                                                    <div style="clear: both;"></div>
                                                    <div style="margin-top: 80px;">
                                                        <asp:Image ID="Image1" runat="server" ImageUrl="~/images/10.gif" CssClass="ZD" />
                                                    </div>
                                                </div>
                                                <br /><br />
                                                <br />
                                                <br />
                                                <div style="text-align: right; font-family: Tahoma; font-size: 11px; font-weight: normal; color: #949494;">
                                                    Автор новости: Крутикова Юлия Александровна
                                                </div>
                                            </div>--%>
                                        </div>
                                        <br />
                                                    ...
                                                    <ItemTemplate>
                                                        <div id="border_type5">
                                                            <table cellpadding="0" cellspacing="0" border="0" width="100%">
                                                                ...
                                                                <tr>
                                                                    <td align="right">
                                                                        <div class="textAvtor"> <label>Время размещения: </label>
                                    ...
                                    <div id="top_base_text" style="width: 100%;">
                                        ...
                                        <asp:UpdateProgress ID="UpdateProgress1" runat="server" AssociatedUpdatePanelID="UpdatePanelNews">
                                            <ProgressTemplate>
                                                <div style="text-align: center; font-family: Verdana; font-weight: bold; color: Black; border: 1px solid black; padding: 10px; margin: 0px auto;">
                                                    <asp:Label ID="LabelDownLoadNews" Text="Внимание идет загрузка новостей ..." runat="server"></asp:Label>
                                                </div>
                                            </ProgressTemplate>
                                        </asp:UpdateProgress>
                                    </div>
                            ...
                            <td width="350px" valign="top" align="left" bgcolor="#F9F9F9">
                                <div class="posForm">
                                    <div style="margin-bottom: 15px">
                                        <%--<uc7:Events_timer ID="Events_timer1" runat="server" />--%>
                                        <%--<uc1:uc_activities runat="server" id="uc_activities" />--%>
                                        <hr />
                                        <uc6:uc_organiser ID="uc_organiser1" runat="server" />   <br /><br />
