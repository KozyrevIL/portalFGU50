...
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
                            <style>span#newyear { font-family:Tahoma; font-size:14px; font-weight:normal; color:#990000; font-weight:bold}</style>
        ...
        <table cellpadding=0 cellspacing=0 border=0 width=100%>
                <tr>
                    ...
                    <td width=100% valign=top align=left>
                        <div class="posForm">
                                            ...
                                            <ItemTemplate>
                                                <div id="border_type5">
                                                    <table cellpadding="0" cellspacing="0" border="0" width="100%">
                                                        <tr height="10px">
                                                            <td>
                                                                <div style="float:left; margin-right:10px"><asp:Label ID="Label3" runat="server" CssClass="textDate" Text='<%# Bind("date_news") %>'></asp:Label></div>
                                                                <div><asp:Label ID="Label1" runat="server" CssClass="headerText2" Text='<%# Bind("header_news") %>'></asp:Label></div>
                                                            </td>
                                                        </tr>
                            ...
                            <div id="top_base_text" style="width: 100%;">
                                <div style="margin-bottom: 20px">
                                    <asp:Label ID="headerRazdel" runat="server" Text="Общественные новости" CssClass="headerRazdel"></asp:Label>
                                </div>
                                                        ...
                                                        <div id="input_border">
                                                            <table cellpadding="0" cellspacing="0" border="0" width="100%">
                                                                <tr >
                                                                    <td height="10px">
                                                                        <div style="float:left; margin-right:10px"><asp:Label ID="Label3" runat="server" CssClass="textDate" Text='<%# Bind("date_news") %>'></asp:Label></div>
                                                                        <div><asp:Label ID="Label9" runat="server" CssClass="headerText2" Text='<%# Bind("header_news") %>'></asp:Label></div>
                                ...
                                <asp:UpdateProgress ID="UpdateProgress1" runat="server" AssociatedUpdatePanelID="UpdatePanelNews">
                                    <ProgressTemplate>
                                        <div style="text-align: center; font-family: Verdana; font-weight: bold; color: Black;
                                            border: 1px solid black; padding: 10px; margin: 0px auto;">
                    ...
                    <td width=350px valign=top align=left bgcolor="#F9F9F9">
                        ...
                        <div class="formText4">
                            Для выборки новостей за определенную дату - нажмите на день календаря</div>
